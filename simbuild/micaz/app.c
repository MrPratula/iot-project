...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bea458, const void *arg_0xb7bea5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b9b8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a45840), 
int (*key_eq_fn)(void *arg_0xb7a45c88, void *arg_0xb7a45e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79149b8, int arg_0xb7914b10);
static double RandomUniform(void );
...
typedef TMilli RadioRouteC$Timer0$precision_tag;
typedef TMilli RadioRouteC$Timer3$precision_tag;
typedef TMilli RadioRouteC$Timer1$precision_tag;
typedef TMilli RadioRouteC$TimerStart$precision_tag;
...
static void RadioRouteC$Timer0$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void RadioRouteC$AMControl$startDone(error_t error);
#line 138
static void RadioRouteC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void RadioRouteC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void RadioRouteC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer3$fired(void );
#line 83
static void RadioRouteC$Timer1$fired(void );
#line 83
static void RadioRouteC$TimerStart$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool RadioRouteC$Timer0$isRunning(void );
#line 73
static void RadioRouteC$Timer0$startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t RadioRouteC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t RadioRouteC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void RadioRouteC$Timer3$startPeriodic(uint32_t dt);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t RadioRouteC$Random$rand16(void );
# 42 "RadioRouteC.nc"
message_t RadioRouteC$packet[1000];


message_t RadioRouteC$queued_packet[1000];
uint16_t RadioRouteC$queue_addr[1000];
uint16_t RadioRouteC$time_delays[1000][7];
...
bool RadioRouteC$locked[1000];

static inline bool RadioRouteC$actual_send(uint16_t address, message_t *packet);
static inline bool RadioRouteC$generate_send(uint16_t address, message_t *packet, uint8_t type);

uint16_t RadioRouteC$random[1000];
uint16_t RadioRouteC$token[1000];
#line 78
#line 64
typedef struct RadioRouteC$sent {
...
RadioRouteC$Box RadioRouteC$sent[1000][32];


static inline bool RadioRouteC$generate_send(uint16_t address, message_t *packet, uint8_t type);
#line 110
static inline void RadioRouteC$Timer0$fired(void );
...
static inline bool RadioRouteC$actual_send(uint16_t address, message_t *packet);
#line 139
static inline void RadioRouteC$Boot$booted(void );
#line 151
static inline void RadioRouteC$AMControl$startDone(error_t err);
#line 190
static inline void RadioRouteC$AMControl$stopDone(error_t err);




static inline void RadioRouteC$Timer1$fired(void );
...
static inline message_t *RadioRouteC$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
#line 251
static void RadioRouteC$AMSend$sendDone(message_t *bufPtr, error_t error);
...
static inline void RadioRouteC$TimerStart$fired(void );
...
static inline void RadioRouteC$Timer3$fired(void );
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
#line 204
{
  ...
  sim_log_debug(162U, "dbg", "receive IN\n");
  ...
  if (len != sizeof(radio_route_msg_t )) {
  ...
  else 
    {
      ...
      data = __nesc_ntoh_uint16(rcm->data.nxdata);
      type = __nesc_ntoh_uint16(rcm->type.nxdata);

      switch (type) {

          case 0: 
            sim_log_debug(163U, "radio_rec", "umidità = %d%\n", data);
          break;
          case 1: 
            sim_log_debug(164U, "radio_rec", "pressione = %dhPa\n", data);
          break;

          case 2: 
            sim_log_debug(165U, "radio_rec", "temperatura = %d°C\n", data);
          break;
        }
    }


  sim_log_debug(166U, "dbg", "receive OUT\n\n");
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76b6ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76b6ac8) {
#line 78
    case 10:
#line 78
      __nesc_result = RadioRouteC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76b6ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76b4178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76b4178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t RadioRouteC$AMControl$start(void ){
#line 104
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioRouteC$Timer3$startPeriodic(uint32_t dt){
#line 64
...
#line 151
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(158U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);

      RadioRouteC$token[sim_node()] = 0;

      for (i = 0; i <= 31; i++) {
          RadioRouteC$sent[sim_node()][i].lock = FALSE;
        }
          ...
          case 1: 
            case 2: 
              case 3: 
                case 4: 
                  case 5: 
                    RadioRouteC$Timer3$startPeriodic(TOS_NODE_ID * 1000);
          break;
        }
    }
  else 
    ...
    {
      sim_log_error(159U, "radio", "Radio failed to start, retrying...\n");
      RadioRouteC$AMControl$start();
    }
}
...
#line 113
  RadioRouteC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 190
{
  sim_log_debug(160U, "boot", "Radio stopped!\n");
}
...
#line 138
  RadioRouteC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76b6108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76b6108, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  RadioRouteC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73a8088, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73a8088) {
#line 100
    case 0U:
#line 100
      /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73a8088, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7870650){
#line 75
  switch (arg_0xb7870650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7870650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73a8a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73a8a70, addr, msg, len);
#line 80
...
#line 91
{
  ...
  sim_log_debug(205U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(206U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(207U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 1;
      ...
      sim_log_debug(208U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}

# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t RadioRouteC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*RadioRouteAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 117
{
  ...
  sim_log_debug(151U, "dbg", "actual send IN\n");

  if (RadioRouteC$locked[sim_node()]) {
      sim_log_debug(152U, "dbg", "actual send OUT bad\n\n");
      return FALSE;
    }
  else {
      if (RadioRouteC$AMSend$send(address, packet, sizeof(radio_route_msg_t )) == SUCCESS) {
          sim_log_debug(153U, "radio_send", "Sending packet");
          RadioRouteC$locked[sim_node()] = TRUE;
          sim_log_debug_clear(154U, "radio_send", " at time %s \n", sim_time_string());
          sim_log_debug(155U, "dbg", "actual send OUT ok\n\n");
          return TRUE;
        }
    }
}
...
#line 110
{
  RadioRouteC$actual_send(RadioRouteC$queue_addr[sim_node()], &RadioRouteC$queued_packet[sim_node()]);
}
...
#line 195
{
  sim_log_debug(161U, "boot", "timer1\n");
}
...
#line 261
{
  ...
  sim_log_debug(169U, "boot", "timer start\n");
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void RadioRouteC$Timer0$startOneShot(uint32_t dt){
#line 73
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool RadioRouteC$Timer0$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 83
{
  ...
  sim_log_debug(148U, "dbg", "generate send IN \n");


  if (RadioRouteC$Timer0$isRunning()) {
      sim_log_debug(149U, "dbg", "generate send OUT \n\n");
      return FALSE;
    }
  else 
#line 92
    {
      if (type == 0) {
          ...
          RadioRouteC$Timer0$startOneShot(RadioRouteC$time_delays[sim_node()][TOS_NODE_ID - 1]);
          RadioRouteC$queued_packet[sim_node()] = *packet;
          RadioRouteC$queue_addr[sim_node()] = address;
        }
      else {
#line 98
        if (type == 1) {
...
#line 104
  sim_log_debug(150U, "dbg", "generate send OUT \n\n");
  return TRUE;
}
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * RadioRouteC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t RadioRouteC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 268
{
  ...
  sim_log_debug(170U, "dbg", "time3 fired IN\n");



  RadioRouteC$random[sim_node()] = RadioRouteC$Random$rand16();


  topic = RadioRouteC$random[sim_node()] % 3;
  sim_log_debug(171U, "random_gen", "numero a caso = %d\n", RadioRouteC$random[sim_node()]);
  sim_log_debug(172U, "random_gen", "topic = %d\n", topic);
  ...
  switch (topic) {
      ...
      case 0: 
        value = RadioRouteC$random[sim_node()] * 100 / 65535;
      sim_log_debug(173U, "random_gen", "umidità = %d%\n", value);
      break;

      case 1: 
        value = 1010 + RadioRouteC$random[sim_node()] / 10000;
      sim_log_debug(174U, "random_gen", "pressione = %dhPa\n", value);
      break;
      ...
      case 2: 
        ...
        value = RadioRouteC$random[sim_node()] * 100 / 65535;
      value = value / 2 - 10;
      sim_log_debug(175U, "random_gen", "temperatura = %dC\n", value);
      break;
    }


  sim_log_debug(176U, "random_gen", "\n");



  rcm = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$packet[sim_node()], sizeof(radio_route_msg_t ));

  __nesc_hton_uint16(rcm->src.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(rcm->dst.nxdata, 8);
  __nesc_hton_uint16(rcm->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(rcm->token.nxdata, RadioRouteC$token[sim_node()]);
  __nesc_hton_uint16(rcm->retrasmission.nxdata, 0);
  __nesc_hton_uint16(rcm->type.nxdata, topic);
  __nesc_hton_uint16(rcm->data.nxdata, value);

  for (i = 0; i <= 31; i++) {
      if (RadioRouteC$sent[sim_node()][i].lock == FALSE) {
          RadioRouteC$sent[sim_node()][i].lock = TRUE;
          RadioRouteC$sent[sim_node()][i].src = TOS_NODE_ID;
          RadioRouteC$sent[sim_node()][i].dst = 8;
          RadioRouteC$sent[sim_node()][i].sender = TOS_NODE_ID;
          RadioRouteC$sent[sim_node()][i].token = RadioRouteC$token[sim_node()];
          RadioRouteC$sent[sim_node()][i].retrasmission = 0;
          RadioRouteC$sent[sim_node()][i].type = topic;
          RadioRouteC$sent[sim_node()][i].data = value;
          break;
        }
    }

  RadioRouteC$token[sim_node()]++;

  RadioRouteC$generate_send(AM_BROADCAST_ADDR, &RadioRouteC$packet[sim_node()], 0);

  sim_log_debug(177U, "dbg", "time3 fired OUT\n\n");
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74163a8){
#line 83
  switch (arg_0xb74163a8) {
#line 83
    case 0U:
#line 83
      RadioRouteC$Timer0$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      RadioRouteC$Timer1$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      RadioRouteC$TimerStart$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      RadioRouteC$Timer3$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74163a8);
#line 83
      break;
#line 83
    }
...
#line 139
{
  sim_log_debug(156U, "boot", "Application booted.\n");
  sim_log_debug(157U, "boot", "started node %d.\n", TOS_NODE_ID);
...
#line 251
{
  if (&RadioRouteC$queued_packet[sim_node()] == bufPtr) {
      RadioRouteC$locked[sim_node()] = FALSE;
      sim_log_debug(167U, "radio_send", "Packet sent...");
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module RadioRouteC */
  if (!strcmp(varname, "RadioRouteC$packet"))
  {
    *addr = (uintptr_t)&RadioRouteC$packet[__nesc_mote];
    *size = sizeof(RadioRouteC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$queued_packet"))
  {
    *addr = (uintptr_t)&RadioRouteC$queued_packet[__nesc_mote];
    *size = sizeof(RadioRouteC$queued_packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$queue_addr"))
  {
    *addr = (uintptr_t)&RadioRouteC$queue_addr[__nesc_mote];
    *size = sizeof(RadioRouteC$queue_addr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$time_delays"))
  {
    *addr = (uintptr_t)&RadioRouteC$time_delays[__nesc_mote];
    *size = sizeof(RadioRouteC$time_delays[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$locked"))
  {
    *addr = (uintptr_t)&RadioRouteC$locked[__nesc_mote];
    *size = sizeof(RadioRouteC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$random"))
  {
    *addr = (uintptr_t)&RadioRouteC$random[__nesc_mote];
    *size = sizeof(RadioRouteC$random[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$token"))
  {
    *addr = (uintptr_t)&RadioRouteC$token[__nesc_mote];
    *size = sizeof(RadioRouteC$token[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$sent"))
  {
    *addr = (uintptr_t)&RadioRouteC$sent[__nesc_mote];
    *size = sizeof(RadioRouteC$sent[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioRouteC */
  memset((void *)&RadioRouteC$packet[__nesc_mote], 0, sizeof RadioRouteC$packet[__nesc_mote]);
  memset((void *)&RadioRouteC$queued_packet[__nesc_mote], 0, sizeof RadioRouteC$queued_packet[__nesc_mote]);
  memset((void *)&RadioRouteC$queue_addr[__nesc_mote], 0, sizeof RadioRouteC$queue_addr[__nesc_mote]);
  memcpy((void *)&RadioRouteC$time_delays[__nesc_mote], (void *)&(unsigned short [7]){ 61, 173, 267, 371, 479, 583, 689 }, sizeof RadioRouteC$time_delays[__nesc_mote]);
  memset((void *)&RadioRouteC$locked[__nesc_mote], 0, sizeof RadioRouteC$locked[__nesc_mote]);
  memset((void *)&RadioRouteC$random[__nesc_mote], 0, sizeof RadioRouteC$random[__nesc_mote]);
  memset((void *)&RadioRouteC$token[__nesc_mote], 0, sizeof RadioRouteC$token[__nesc_mote]);
  memset((void *)&RadioRouteC$sent[__nesc_mote], 0, sizeof RadioRouteC$sent[__nesc_mote]);
