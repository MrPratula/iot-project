...
static inline void RadioRouteC$AMSend$sendDone(message_t *bufPtr, error_t error);
...
#line 174
{
  ...
  sim_log_debug(155U, "boot", "receive.receive\n");
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76ecac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76ecac8) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76ecac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 133
{
  ...
  if (err == SUCCESS) {
    ...
    {
      sim_log_error(152U, "radio", "Radio failed to start, retrying...\n");
...
#line 165
{
  sim_log_debug(153U, "boot", "Radio stopped!\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76ec108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76ec108, msg, error);
#line 110
}
#line 110
...
#line 180
{
  sim_log_debug(156U, "boot", "send done\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73f5088, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73f5088) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73f5088, msg, error);
#line 100
      break;
#line 100
    }
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73f5a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73f5a70, addr, msg, len);
#line 80
...
#line 112
{
  ...
  sim_log_debug(148U, "boot", "actual send fired at node %d.\n", TOS_NODE_ID);
}
...
#line 170
{
  sim_log_debug(154U, "boot", "timer1\n");
}
...
#line 186
{
  ...
  sim_log_debug(157U, "boot", "timer start\n");
}
...
#line 193
{
  ...
  sim_log_debug(158U, "boot", "numero a caso = %d\n", RadioRouteC$random[sim_node()]);
  sim_log_debug(159U, "boot", "topic = %d\n", topic);
  ...
  switch (topic) {
      ...
      sim_log_debug(160U, "boot", "umidità = %d%\n", value);
      break;

      case 1: 
        value = 1010 + RadioRouteC$random[sim_node()] / 10000;
      sim_log_debug(161U, "boot", "pressione = %dhPa\n", value);
      break;
      ...
      case 2: 
        ...
        value = RadioRouteC$random[sim_node()] * 100 / 65535;
      value = value / 2 - 10;
      sim_log_debug(162U, "boot", "temperatura = %dC\n", value);
      break;
    }


  sim_log_debug(163U, "boot", "\n");
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74633a8){
#line 83
  switch (arg_0xb74633a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74633a8);
#line 83
      break;
#line 83
    }
...
#line 121
{
  ...
  sim_log_debug(150U, "boot", "started node %d.\n", TOS_NODE_ID);
